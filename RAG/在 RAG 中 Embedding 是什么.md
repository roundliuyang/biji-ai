...
Embedding 模型做的事情本质上是**「语义压缩」**，把一段**自然语言文本**映射成一个**固定长度的浮点数向量**。比如一个 1024 维的 Embedding 模型，不管输入的文本是 10 个字还是 500 个字，输出都是一个长度为 1024 的数字列表。
...
![img](在 RAG 中 Embedding 是什么.assets/1776785681727-c4cff85e-ba89-4f3a-8a1d-f7e83d831962.webp)
...
![img](在 RAG 中 Embedding 是什么.assets/1776785589594-287326ed-4c1d-4799-82ef-0ecca4ec0487.webp)
...
- 第三是**向量维度**对存储和检索速度的影响：维度越高精度越好，但存储空间和检索时间都会增加。百万量级的知识库，1024 维是个合理的平衡点；如果规模很小，1536 维也无所谓。有些新模型（如 text-embedding-3-small）支持 Matryoshka 降维，可以灵活调整维度来平衡精度和成本。
  ...
  ![img](在 RAG 中 Embedding 是什么.assets/1776785708927-48d16f1c-c72a-4eef-a17a-81b3131e0ffb.webp)
...
![img](在 RAG 中 Embedding 是什么.assets/1776785735184-c7ccd408-ce4f-4952-96d5-69d36cfed030.webp)
...
![img](在 RAG 中 Embedding 是什么.assets/image-20260310180341826.png)
...
![img](在 RAG 中 Embedding 是什么.assets/1776785947203-e57e51f1-bfd9-4ad4-9fcf-027fda537272.webp)
...
你可能会觉得百万次也不算多吧？别忘了 BERT 一次前向传播就要几十毫秒，百万次就是好几个小时，用户根本等不起。这个问题直接导致了第三代的诞生。

![img](在 RAG 中 Embedding 是什么.assets/1776785906281-75df6194-ebc4-494c-892f-4058bf16ca95.webp)
...
![img](在 RAG 中 Embedding 是什么.assets/1776785977955-61600597-2b86-4656-a10c-ff00b75a886f.webp)
...
![img](在 RAG 中 Embedding 是什么.assets/1776786056751-3aab642b-f729-4fc8-b06e-353d8feb9273.webp)

**BGE** (BAAI General Embedding，北京智源研究院) 是中文 RAG 场景非常流行的开源模型，基于对比学习在大规模中文英文数据上训练，同时支持 bi-encoder 和 reranker 两种形态，专门为检索场景优化。E5 (微软) 是另一个常用的英文对比学习 Embedding，效果同样优秀。
